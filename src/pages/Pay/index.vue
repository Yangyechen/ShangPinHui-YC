...
// 生命周期函数不允许加async||await
  ...
  methods: {
    ...
    async open() {
      ...
      // let url = await QRCode.toDataURL('weixin://wxpay/bizpayur?pr=X10zZo1zz')
      // console.log(url)
      this.$alert(`<img src="${url}" alt="二维码" />`, '微信支付', {
        ...
        roundButton: true,
        // 关闭弹出框的配置
        // action 区分是哪个按钮 instance当前组件实例 done 关闭弹出层的方法
